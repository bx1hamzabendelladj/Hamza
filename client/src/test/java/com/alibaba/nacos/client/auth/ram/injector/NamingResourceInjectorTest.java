...
class NamingResourceInjectorTest {
    ...
    @Test
    void doInjectWithEmpty() throws Exception {
    ...
    @Test
    void doInjectWithGroup() throws Exception {
    ...
    @Test
    void doInjectWithoutGroup() throws Exception {
    ...
    @Test
    void doInjectWithGroupForSts() throws Exception {
        prepareForSts();
        resource = RequestResource.namingBuilder().setResource("test@@aaa").setGroup("group").build();
        LoginIdentityContext actual = new LoginIdentityContext();
        namingResourceInjector.doInject(resource, ramContext, actual);
    ...
    @Test
    void doInjectWithoutGroupForSts() throws Exception {
        prepareForSts();
        resource = RequestResource.namingBuilder().setResource("aaa").setGroup("group").build();
        LoginIdentityContext actual = new LoginIdentityContext();
        namingResourceInjector.doInject(resource, ramContext, actual);
    ...
    @Test
    void doInjectForStsWithException() throws Exception {
        prepareForSts();
