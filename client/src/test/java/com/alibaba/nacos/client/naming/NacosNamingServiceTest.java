...
class NacosNamingServiceTest {
    ...
    @Test
    void registerInstance1() throws NacosException {
        //given
    ...
    @Test
    void batchRegisterInstance() throws NacosException {
    ...
    @Test
    void batchRegisterInstanceWithGroupNamePrefix() throws NacosException {
        Instance instance = new Instance();
        String serviceName = "service1";
        String ip = "1.1.1.1";
        int port = 10000;
    ...
    @Test
    void batchRegisterInstanceWithWrongGroupNamePrefix() throws NacosException {
        Instance instance = new Instance();
        String serviceName = "service1";
        String ip = "1.1.1.1";
        int port = 10000;
    ...
    @Test
    void batchDeRegisterInstance() throws NacosException {
        Instance instance = new Instance();
        String serviceName = "service1";
        String ip = "1.1.1.1";
        int port = 10000;
    ...
    @Test
    void registerInstance2() throws NacosException {
        //given
        String serviceName = "service1";
    ...
    @Test
    void registerInstance3() throws NacosException {
        //given
        String serviceName = "service1";
    ...
    @Test
    void registerInstance4() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        String clusterName = "cluster1";
    ...
    @Test
    void registerInstance5() throws NacosException {
        //given
        String serviceName = "service1";
        Instance instance = new Instance();
        //when
    ...
    @Test
    void registerInstance6() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        Instance instance = new Instance();
    ...
    @Test
    void registerInstance7() throws NacosException {
    ...
    @Test
    void deregisterInstance1() throws NacosException {
        //given
        String serviceName = "service1";
        String ip = "1.1.1.1";
        int port = 10000;
    ...
    @Test
    void deregisterInstance2() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        String ip = "1.1.1.1";
    ...
    @Test
    void deregisterInstance3() throws NacosException {
        //given
        String serviceName = "service1";
        String clusterName = "cluster1";
        String ip = "1.1.1.1";
    ...
    @Test
    void deregisterInstance4() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        String clusterName = "cluster1";
    ...
    @Test
    void deregisterInstance5() throws NacosException {
        //given
        String serviceName = "service1";
        Instance instance = new Instance();
        //when
    ...
    @Test
    void deregisterInstance6() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        Instance instance = new Instance();
    ...
    @Test
    void getAllInstances1() throws NacosException {
        //given
        String serviceName = "service1";
        //when
    ...
    @Test
    void getAllInstances2() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        //when
    ...
    @Test
    void getAllInstances3() throws NacosException {
        //given
        String serviceName = "service1";
        //when
    ...
    @Test
    void getAllInstances4() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        //when
    ...
    @Test
    void getAllInstances5() throws NacosException {
        //given
        String serviceName = "service1";
    ...
    @Test
    void getAllInstances6() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
    ...
    @Test
    void getAllInstances7() throws NacosException {
        //given
        String serviceName = "service1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
        //when
    ...
    @Test
    void getAllInstances8() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
    ...
    @Test
    void getAllInstanceFromFailover() throws NacosException {
    ...
    @Test
    void getAllInstanceFromFailoverEmpty() throws NacosException {
        when(serviceInfoHolder.isFailoverSwitch()).thenReturn(true);
        ServiceInfo serviceInfo = new ServiceInfo("group1@@service1");
        when(serviceInfoHolder.getFailoverServiceInfo(anyString(), anyString(), anyString())).thenReturn(serviceInfo);
        List<Instance> actual = client.getAllInstances("service1", "group1", false);
    ...
    @Test
    void selectInstances1() throws NacosException {
        //given
        String serviceName = "service1";
        //when
    ...
    @Test
    void selectInstances2() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        //when
    ...
    @Test
    void selectInstances3() throws NacosException {
        //given
        String serviceName = "service1";
        //when
    ...
    @Test
    void selectInstances4() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        //when
    ...
    @Test
    void selectInstances5() throws NacosException {
        //given
        String serviceName = "service1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
        //when
    ...
    @Test
    void selectInstances6() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
    ...
    @Test
    void selectInstances7() throws NacosException {
        //given
        String serviceName = "service1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
        //when
    ...
    @Test
    void selectInstances8() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
    ...
    @Test
    void selectInstancesWithHealthyFlag() throws NacosException {
        //given
    ...
    @Test
    void selectOneHealthyInstance1() throws NacosException {
        //given
        Instance healthyInstance = new Instance();
    ...
    @Test
    void selectOneHealthyInstance2() throws NacosException {
        //given
        Instance healthyInstance = new Instance();
        healthyInstance.setIp("1.1.1.1");
        healthyInstance.setPort(1000);
    ...
    @Test
    void selectOneHealthyInstance3() throws NacosException {
        //given
        Instance healthyInstance = new Instance();
        healthyInstance.setIp("1.1.1.1");
        healthyInstance.setPort(1000);
    ...
    @Test
    void selectOneHealthyInstance4() throws NacosException {
        //given
        Instance healthyInstance = new Instance();
        healthyInstance.setIp("1.1.1.1");
        healthyInstance.setPort(1000);
    ...
    @Test
    void selectOneHealthyInstance5() throws NacosException {
        //given
        Instance healthyInstance = new Instance();
        healthyInstance.setIp("1.1.1.1");
        healthyInstance.setPort(1000);
    ...
    @Test
    void selectOneHealthyInstance6() throws NacosException {
        //given
        Instance healthyInstance = new Instance();
        healthyInstance.setIp("1.1.1.1");
        healthyInstance.setPort(1000);
    ...
    @Test
    void selectOneHealthyInstance7() throws NacosException {
        //given
        Instance healthyInstance = new Instance();
        healthyInstance.setIp("1.1.1.1");
        healthyInstance.setPort(1000);
    ...
    @Test
    void selectOneHealthyInstance8() throws NacosException {
        //given
        Instance healthyInstance = new Instance();
        healthyInstance.setIp("1.1.1.1");
        healthyInstance.setPort(1000);
    ...
    @Test
    void subscribe1() throws NacosException {
        //given
        String serviceName = "service1";
    ...
    @Test
    void subscribe2() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        EventListener listener = event -> {
    ...
    @Test
    void subscribe3() throws NacosException {
        //given
        String serviceName = "service1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
        EventListener listener = event -> {
    ...
    @Test
    void subscribe4() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
    ...
    @Test
    void subscribeWithNullListener() throws NacosException {
        String serviceName = "service1";
        String groupName = "group1";
        //when
    ...
    @Test
    void unSubscribe1() throws NacosException {
        //given
        String serviceName = "service1";
        EventListener listener = event -> {
    ...
    @Test
    void unSubscribe2() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        EventListener listener = event -> {
    ...
    @Test
    void unSubscribe3() throws NacosException {
        //given
        String serviceName = "service1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
        EventListener listener = event -> {
    ...
    @Test
    void unSubscribe4() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        List<String> clusterList = Arrays.asList("cluster1", "cluster2");
    ...
    @Test
    void getServicesOfServer1() throws NacosException {
        //given
        int pageNo = 1;
        int pageSize = 10;
        //when
    ...
    @Test
    void getServicesOfServer2() throws NacosException {
        //given
        int pageNo = 1;
        int pageSize = 10;
        String groupName = "group1";
    ...
    @Test
    void getServicesOfServer3() throws NacosException {
        //given
        int pageNo = 1;
        int pageSize = 10;
    ...
    @Test
    void getServicesOfServer4() throws NacosException {
        //given
        int pageNo = 1;
        int pageSize = 10;
        String groupName = "group1";
    ...
    @Test
    void constructorWithServerList() throws NacosException, NoSuchFieldException, IllegalAccessException {
