...
class NacosNamingMaintainServiceTest {
    ...
    @Test
    void constructor() throws NacosException {
        NacosNamingMaintainService client = new NacosNamingMaintainService("localhost");
        assertNotNull(client);
    }
    
    @Test
    void updateInstance1() throws NacosException {
        //given
    ...
    @Test
    void updateInstance2() throws NacosException {
        //given
        String serviceName = "service1";
        Instance instance = new Instance();
        //when
    ...
    @Test
    void queryService1() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "group1";
        //when
    ...
    @Test
    void queryService2() throws NacosException {
        //given
        String serviceName = "service1";
        Instance instance = new Instance();
        //when
    ...
    @Test
    void createService1() throws NacosException {
        //given
        String serviceName = "service1";
        //when
    ...
    @Test
    void createService2() throws NacosException {
        //given
        String serviceName = "service1";
    ...
    @Test
    void createService3() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "groupName";
    ...
    @Test
    void createService5() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "groupName";
        float protectThreshold = 0.1f;
    ...
    @Test
    void createService4() throws NacosException {
        //given
    ...
    @Test
    void deleteService1() throws NacosException {
        //given
        String serviceName = "service1";
        //when
    ...
    @Test
    void deleteService2() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "groupName";
        //when
    ...
    @Test
    void updateService1() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "groupName";
        float protectThreshold = 0.1f;
    ...
    @Test
    void updateService2() throws NacosException {
        //given
        String serviceName = "service1";
        String groupName = "groupName";
        float protectThreshold = 0.1f;
    ...
    @Test
    void updateService3() throws NacosException {
        //given
        Service service = new Service();
        AbstractSelector selector = new NoneSelector();
        //when
