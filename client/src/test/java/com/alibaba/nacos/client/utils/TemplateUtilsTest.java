...
class TemplateUtilsTest {
    ...
    @Test
    void stringNotEmptyAndThenExecuteSuccess() {
        String word = "run";
    ...
    @Test
    void stringNotEmptyAndThenExecuteFail() {
        String word = "";
        Runnable task = Mockito.mock(Runnable.class);
        TemplateUtils.stringNotEmptyAndThenExecute(word, task);
    ...
    @Test
    void stringNotEmptyAndThenExecuteException() {
        String word = "run";
        Runnable task = Mockito.mock(Runnable.class);
    ...
    @Test
    void stringEmptyAndThenExecuteSuccess() {
        String word = "   ";
    ...
    @Test
    void stringEmptyAndThenExecuteFail() {
        String word = "";
    ...
    @Test
    void stringEmptyAndThenExecuteException() throws Exception {
    ...
    @Test
    void stringBlankAndThenExecuteSuccess() {
        String word = "success";
    ...
    @Test
    void stringBlankAndThenExecuteFail() {
        String word = "   ";
        final String expect = "call";
    ...
    @Test
    void stringBlankAndThenExecuteException() throws Exception {
        Callable callable = mock(Callable.class);
        when(callable.call()).thenThrow(new RuntimeException("test"));
