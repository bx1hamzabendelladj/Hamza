...
class CacheDirUtilTest {
    ...
    @Test
    void initCacheDirWithDefaultRootAndWithoutCache() {
    ...
    @Test
    void initCacheDirWithDefaultRootAndWithCache() {
        System.setProperty("user.home", "/home/admin");
    ...
    @Test
    void initCacheDirWithJmSnapshotPathRootAndWithoutCache() {
    ...
    @Test
    void initCacheDirWithJmSnapshotPathRootAndWithCache() {
