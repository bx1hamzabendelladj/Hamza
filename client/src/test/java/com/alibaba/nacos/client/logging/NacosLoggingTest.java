...
class NacosLoggingTest {
    ...
    @Test
    void loadConfiguration() throws NoSuchFieldException, IllegalAccessException {
        instance = NacosLogging.getInstance();
    ...
    @Test
    void loadConfigurationWithException() throws NoSuchFieldException, IllegalAccessException {
        instance = NacosLogging.getInstance();
