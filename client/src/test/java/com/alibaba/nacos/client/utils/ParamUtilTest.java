...
class ParamUtilTest {
    ...
    @Test
    void initConnectionTimeoutWithException() throws Throwable {
    ...
    @Test
    void initPerTaskConfigSizeWithException() throws Throwable {
        assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    void parsingEndpointRuleFromSystem() {
    ...
    @Test
    void simplyEnvNameNotOverLimit() {
        String expect = "test";
