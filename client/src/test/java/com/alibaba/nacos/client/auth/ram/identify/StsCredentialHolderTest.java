...
class StsCredentialHolderTest {
    ...
    @Test
    void getStsCredentialFromCache() throws NoSuchFieldException, IllegalAccessException {
    ...
    @Test
    void getStsCredentialFromStringCache() throws NoSuchFieldException, IllegalAccessException {
        StsCredential stsCredential = buildMockStsCredential();
    ...
    @Test
    void getStsCredentialFromRequest() throws Exception {
        StsCredential stsCredential = buildMockStsCredential();
    ...
    @Test
    void getStsCredentialFromRequestFailure() throws Exception {
    ...
    @Test
    void getStsCredentialFromRequestException() throws Exception {
        assertThrows(NacosRuntimeException.class, () -> {
