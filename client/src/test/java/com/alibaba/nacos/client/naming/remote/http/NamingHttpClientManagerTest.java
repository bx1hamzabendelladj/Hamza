...
class NamingHttpClientManagerTest {
    ...
    @Test
    void getNacosRestTemplate() {
        assertNotNull(NamingHttpClientManager.getInstance().getNacosRestTemplate());
    }
    
    @Test
    void shutdown() throws NoSuchFieldException, IllegalAccessException, NacosException, IOException {
        //given
    ...
    @Test
    void shutdownWithException() throws Exception {
