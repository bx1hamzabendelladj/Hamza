...
class DiskCacheTest {
    ...
    @Test
    void readCacheForNullFile() {
        Map<String, ServiceInfo> actual = DiskCache.read(null);
        assertTrue(actual.isEmpty());
    }
    
    @Test
    void parseServiceInfoFromNonExistFile() throws UnsupportedEncodingException {
    ...
    @Test
    void createFileIfAbsentForDir() throws Throwable {
    ...
    @Test
    void createFileIfAbsentForFile() throws Throwable {
        assertThrows(IllegalStateException.class, () -> {
            File file = mock(File.class);
